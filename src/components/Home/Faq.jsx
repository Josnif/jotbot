              ...
              <details className="group">
                <summary className="flex justify-between text-white items-center cursor-pointer list-none">
                  ...
                  <span className="transition group-open:rotate-180">
                    <svg fill="none" height="24" shapeRendering="geometricPrecision" stroke="currentColor" strokeLinejoin="round" strokeLinecap="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24"><path d="M6 9l6 6 6-6"></path></svg>
                  </span>
                </summary>
